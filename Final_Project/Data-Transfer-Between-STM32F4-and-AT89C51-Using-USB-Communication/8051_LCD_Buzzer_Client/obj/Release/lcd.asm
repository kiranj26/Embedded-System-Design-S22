...
_handle_sadsmiley_custom_char_sloc0_1_0:
	.ds 1
_handle_lock_custom_char_sloc0_1_0:
	.ds 1
_handle_unlock_custom_char_sloc0_1_0:
	.ds 1
_handle_newuser_custom_char_sloc0_1_0:
	.ds 1
...
_handle_sadsmiley_custom_char_row_vals4_65540_199:
	.ds 8
_handle_lock_custom_char_row_vals1_65536_202:
	.ds 8
_handle_lock_custom_char_row_vals2_65537_204:
	.ds 8
_handle_lock_custom_char_row_vals3_65538_206:
	.ds 8
_handle_lock_custom_char_row_vals4_65539_208:
	.ds 8
_handle_unlock_custom_char_row_vals1_65536_211:
	.ds 8
_handle_unlock_custom_char_row_vals2_65537_213:
	.ds 8
_handle_unlock_custom_char_row_vals3_65538_215:
	.ds 8
_handle_unlock_custom_char_row_vals4_65539_217:
	.ds 8
_handle_newuser_custom_char_row_vals1_65536_220:
	.ds 8
_handle_newuser_custom_char_row_vals2_65537_222:
	.ds 8
_handle_newuser_custom_char_row_vals3_65538_224:
	.ds 8
_handle_newuser_custom_char_row_vals4_65539_226:
	.ds 8
;--------------------------------------------------------
...
;------------------------------------------------------------
;	lcd.c:611: void handle_sadsmiley_custom_char(void)
;	-----------------------------------------
;	 function handle_sadsmiley_custom_char
;	-----------------------------------------
_handle_sadsmiley_custom_char:
;	lcd.c:614: printf("\033[0;33m");
	mov	a,#___str_29
	push	acc
	mov	a,#(___str_29 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	lcd.c:617: save_cursor_address = get_cursor_address();
	lcall	_get_cursor_address
	mov	a,dpl
	mov	dptr,#_save_cursor_address
	movx	@dptr,a
;	lcd.c:621: unsigned char row_vals1[8] = {0x1F, 0x1F, 0x11, 0x15, 0x11, 0x1F, 0x1F, 0x1F};
...
00103$:
;	lcd.c:624: create_custom_char(ccode1, row_vals1);
	mov	dptr,#_create_custom_char_PARM_2
	...
	mov	dpl,#0x31
	lcall	_create_custom_char
;	lcd.c:626: lcdgotoxy('1', '4');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x34
	movx	@dptr,a
	mov	dpl,#0x31
	lcall	_lcdgotoxy
;	lcd.c:627: lcdputch(ccode1 - '0');
	mov	dpl,#0x01
	lcall	_lcdputch
	mov	c,_handle_sadsmiley_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:632: unsigned char row_vals2[8] = {0x1F, 0x1F, 0x11, 0x15, 0x11, 0x1F, 0x1F, 0x1F};
...
;	lcd.c:641: }
	...
	clr	_handle_sadsmiley_custom_char_sloc0_1_0
00104$:
;	lcd.c:635: create_custom_char(ccode2, row_vals2);
	mov	dptr,#_create_custom_char_PARM_2
	...
	mov	dpl,#0x32
	lcall	_create_custom_char
;	lcd.c:637: lcdgotoxy('1', '5');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x35
	movx	@dptr,a
	mov	dpl,#0x31
	lcall	_lcdgotoxy
;	lcd.c:638: lcdputch(ccode2 - '0');
	mov	dpl,#0x02
	lcall	_lcdputch
;	lcd.c:640: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
	mov	c,_handle_sadsmiley_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:645: unsigned char row_vals3[8] = {0x1F, 0x1F, 0x1F, 0x10, 0x1B, 0x1C, 0x1F, 0x1F};
...
;	lcd.c:654: }
	...
	clr	_handle_sadsmiley_custom_char_sloc0_1_0
00105$:
;	lcd.c:648: create_custom_char(ccode3, row_vals3);
	mov	dptr,#_create_custom_char_PARM_2
	...
	mov	dpl,#0x33
	lcall	_create_custom_char
;	lcd.c:650: lcdgotoxy('2', '4');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x34
	movx	@dptr,a
	mov	dpl,#0x32
	lcall	_lcdgotoxy
;	lcd.c:651: lcdputch(ccode3 - '0');
	mov	dpl,#0x03
	lcall	_lcdputch
;	lcd.c:653: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
	mov	c,_handle_sadsmiley_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:658: unsigned char row_vals4[8] = {0x1F, 0x1F, 0x1F, 0x01, 0x1B, 0x07, 0x1F, 0x1F};
...
;	lcd.c:667: }
	...
	clr	_handle_sadsmiley_custom_char_sloc0_1_0
00106$:
;	lcd.c:661: create_custom_char(ccode4, row_vals4);
	mov	dptr,#_create_custom_char_PARM_2
	...
	mov	dpl,#0x34
	lcall	_create_custom_char
;	lcd.c:663: lcdgotoxy('2', '5');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x35
	movx	@dptr,a
	mov	dpl,#0x32
	lcall	_lcdgotoxy
;	lcd.c:664: lcdputch(ccode4 - '0');
	mov	dpl,#0x04
	lcall	_lcdputch
;	lcd.c:666: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
...
;	lcd.c:671: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'handle_lock_custom_char'
;------------------------------------------------------------
;ccode1                    Allocated with name '_handle_lock_custom_char_ccode1_65536_202'
;row_vals1                 Allocated with name '_handle_lock_custom_char_row_vals1_65536_202'
;ccode2                    Allocated with name '_handle_lock_custom_char_ccode2_65537_204'
;row_vals2                 Allocated with name '_handle_lock_custom_char_row_vals2_65537_204'
;ccode3                    Allocated with name '_handle_lock_custom_char_ccode3_65538_206'
;row_vals3                 Allocated with name '_handle_lock_custom_char_row_vals3_65538_206'
;ccode4                    Allocated with name '_handle_lock_custom_char_ccode4_65539_208'
;row_vals4                 Allocated with name '_handle_lock_custom_char_row_vals4_65539_208'
;------------------------------------------------------------
;	lcd.c:672: void handle_lock_custom_char(void)
;	-----------------------------------------
;	 function handle_lock_custom_char
;	-----------------------------------------
_handle_lock_custom_char:
;	lcd.c:676: unsigned char row_vals1[8] = {0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F};
	mov	dptr,#_handle_lock_custom_char_row_vals1_65536_202
	mov	a,#0x1f
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals1_65536_202 + 0x0001)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals1_65536_202 + 0x0002)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals1_65536_202 + 0x0003)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals1_65536_202 + 0x0004)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals1_65536_202 + 0x0005)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals1_65536_202 + 0x0006)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals1_65536_202 + 0x0007)
	movx	@dptr,a
;	lcd.c:683: }
	setb	_handle_lock_custom_char_sloc0_1_0
	jbc	ea,00103$
	clr	_handle_lock_custom_char_sloc0_1_0
00103$:
;	lcd.c:679: create_custom_char(ccode1, row_vals1);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_lock_custom_char_row_vals1_65536_202
	movx	@dptr,a
	mov	a,#(_handle_lock_custom_char_row_vals1_65536_202 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x31
	lcall	_create_custom_char
;	lcd.c:681: lcdgotoxy('3', '7');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x37
	movx	@dptr,a
	mov	dpl,#0x33
	lcall	_lcdgotoxy
;	lcd.c:682: lcdputch(ccode1 - '0');
	mov	dpl,#0x01
	lcall	_lcdputch
	mov	c,_handle_lock_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:687: unsigned char row_vals2[8] = {0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F};
	mov	dptr,#_handle_lock_custom_char_row_vals2_65537_204
	mov	a,#0x1f
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals2_65537_204 + 0x0001)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals2_65537_204 + 0x0002)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals2_65537_204 + 0x0003)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals2_65537_204 + 0x0004)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals2_65537_204 + 0x0005)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals2_65537_204 + 0x0006)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals2_65537_204 + 0x0007)
	movx	@dptr,a
;	lcd.c:696: }
	setb	_handle_lock_custom_char_sloc0_1_0
	jbc	ea,00104$
	clr	_handle_lock_custom_char_sloc0_1_0
00104$:
;	lcd.c:690: create_custom_char(ccode2, row_vals2);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_lock_custom_char_row_vals2_65537_204
	movx	@dptr,a
	mov	a,#(_handle_lock_custom_char_row_vals2_65537_204 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x32
	lcall	_create_custom_char
;	lcd.c:692: lcdgotoxy('3', '8');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x38
	movx	@dptr,a
	mov	dpl,#0x33
	lcall	_lcdgotoxy
;	lcd.c:693: lcdputch(ccode2 - '0');
	mov	dpl,#0x02
	lcall	_lcdputch
;	lcd.c:695: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
	mov	c,_handle_lock_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:700: unsigned char row_vals3[8] = {0x03, 0x04, 0x08, 0x10, 0x10, 0x10, 0x10, 0x10};
	mov	dptr,#_handle_lock_custom_char_row_vals3_65538_206
	mov	a,#0x03
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals3_65538_206 + 0x0001)
	inc	a
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals3_65538_206 + 0x0002)
	rl	a
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals3_65538_206 + 0x0003)
	rl	a
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals3_65538_206 + 0x0004)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals3_65538_206 + 0x0005)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals3_65538_206 + 0x0006)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals3_65538_206 + 0x0007)
	movx	@dptr,a
;	lcd.c:709: }
	setb	_handle_lock_custom_char_sloc0_1_0
	jbc	ea,00105$
	clr	_handle_lock_custom_char_sloc0_1_0
00105$:
;	lcd.c:703: create_custom_char(ccode3, row_vals3);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_lock_custom_char_row_vals3_65538_206
	movx	@dptr,a
	mov	a,#(_handle_lock_custom_char_row_vals3_65538_206 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x33
	lcall	_create_custom_char
;	lcd.c:705: lcdgotoxy('2', '7');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x37
	movx	@dptr,a
	mov	dpl,#0x32
	lcall	_lcdgotoxy
;	lcd.c:706: lcdputch(ccode3 - '0');
	mov	dpl,#0x03
	lcall	_lcdputch
;	lcd.c:708: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
	mov	c,_handle_lock_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:713: unsigned char row_vals4[8] = {0x18, 0x04, 0x02, 0x01, 0x01, 0x01, 0x01, 0x01};
	mov	dptr,#_handle_lock_custom_char_row_vals4_65539_208
	mov	a,#0x18
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals4_65539_208 + 0x0001)
	mov	a,#0x04
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals4_65539_208 + 0x0002)
	rr	a
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals4_65539_208 + 0x0003)
	dec	a
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals4_65539_208 + 0x0004)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals4_65539_208 + 0x0005)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals4_65539_208 + 0x0006)
	movx	@dptr,a
	mov	dptr,#(_handle_lock_custom_char_row_vals4_65539_208 + 0x0007)
	movx	@dptr,a
;	lcd.c:722: }
	setb	_handle_lock_custom_char_sloc0_1_0
	jbc	ea,00106$
	clr	_handle_lock_custom_char_sloc0_1_0
00106$:
;	lcd.c:716: create_custom_char(ccode4, row_vals4);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_lock_custom_char_row_vals4_65539_208
	movx	@dptr,a
	mov	a,#(_handle_lock_custom_char_row_vals4_65539_208 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x34
	lcall	_create_custom_char
;	lcd.c:718: lcdgotoxy('2', '8');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x38
	movx	@dptr,a
	mov	dpl,#0x32
	lcall	_lcdgotoxy
;	lcd.c:719: lcdputch(ccode4 - '0');
	mov	dpl,#0x04
	lcall	_lcdputch
;	lcd.c:721: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
...
;	lcd.c:724: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'handle_unlock_custom_char'
;------------------------------------------------------------
;ccode1                    Allocated with name '_handle_unlock_custom_char_ccode1_65536_211'
;row_vals1                 Allocated with name '_handle_unlock_custom_char_row_vals1_65536_211'
;ccode2                    Allocated with name '_handle_unlock_custom_char_ccode2_65537_213'
;row_vals2                 Allocated with name '_handle_unlock_custom_char_row_vals2_65537_213'
;ccode3                    Allocated with name '_handle_unlock_custom_char_ccode3_65538_215'
;row_vals3                 Allocated with name '_handle_unlock_custom_char_row_vals3_65538_215'
;ccode4                    Allocated with name '_handle_unlock_custom_char_ccode4_65539_217'
;row_vals4                 Allocated with name '_handle_unlock_custom_char_row_vals4_65539_217'
;------------------------------------------------------------
;	lcd.c:726: void handle_unlock_custom_char(void)
;	-----------------------------------------
;	 function handle_unlock_custom_char
;	-----------------------------------------
_handle_unlock_custom_char:
;	lcd.c:730: unsigned char row_vals1[8] = {0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F};
	mov	dptr,#_handle_unlock_custom_char_row_vals1_65536_211
	mov	a,#0x1f
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals1_65536_211 + 0x0001)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals1_65536_211 + 0x0002)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals1_65536_211 + 0x0003)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals1_65536_211 + 0x0004)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals1_65536_211 + 0x0005)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals1_65536_211 + 0x0006)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals1_65536_211 + 0x0007)
	movx	@dptr,a
;	lcd.c:737: }
	setb	_handle_unlock_custom_char_sloc0_1_0
	jbc	ea,00103$
	clr	_handle_unlock_custom_char_sloc0_1_0
00103$:
;	lcd.c:733: create_custom_char(ccode1, row_vals1);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_unlock_custom_char_row_vals1_65536_211
	movx	@dptr,a
	mov	a,#(_handle_unlock_custom_char_row_vals1_65536_211 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x31
	lcall	_create_custom_char
;	lcd.c:735: lcdgotoxy('3', '7');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x37
	movx	@dptr,a
	mov	dpl,#0x33
	lcall	_lcdgotoxy
;	lcd.c:736: lcdputch(ccode1 - '0');
	mov	dpl,#0x01
	lcall	_lcdputch
	mov	c,_handle_unlock_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:741: unsigned char row_vals2[8] = {0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F};
	mov	dptr,#_handle_unlock_custom_char_row_vals2_65537_213
	mov	a,#0x1f
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals2_65537_213 + 0x0001)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals2_65537_213 + 0x0002)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals2_65537_213 + 0x0003)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals2_65537_213 + 0x0004)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals2_65537_213 + 0x0005)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals2_65537_213 + 0x0006)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals2_65537_213 + 0x0007)
	movx	@dptr,a
;	lcd.c:750: }
	setb	_handle_unlock_custom_char_sloc0_1_0
	jbc	ea,00104$
	clr	_handle_unlock_custom_char_sloc0_1_0
00104$:
;	lcd.c:744: create_custom_char(ccode2, row_vals2);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_unlock_custom_char_row_vals2_65537_213
	movx	@dptr,a
	mov	a,#(_handle_unlock_custom_char_row_vals2_65537_213 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x32
	lcall	_create_custom_char
;	lcd.c:746: lcdgotoxy('3', '8');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x38
	movx	@dptr,a
	mov	dpl,#0x33
	lcall	_lcdgotoxy
;	lcd.c:747: lcdputch(ccode2 - '0');
	mov	dpl,#0x02
	lcall	_lcdputch
;	lcd.c:749: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
	mov	c,_handle_unlock_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:754: unsigned char row_vals3[8] = {0x18, 0x04, 0x02, 0x01, 0x01, 0x01, 0x01, 0x01};
	mov	dptr,#_handle_unlock_custom_char_row_vals3_65538_215
	mov	a,#0x18
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals3_65538_215 + 0x0001)
	mov	a,#0x04
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals3_65538_215 + 0x0002)
	rr	a
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals3_65538_215 + 0x0003)
	dec	a
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals3_65538_215 + 0x0004)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals3_65538_215 + 0x0005)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals3_65538_215 + 0x0006)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals3_65538_215 + 0x0007)
	movx	@dptr,a
;	lcd.c:764: }
	setb	_handle_unlock_custom_char_sloc0_1_0
	jbc	ea,00105$
	clr	_handle_unlock_custom_char_sloc0_1_0
00105$:
;	lcd.c:758: create_custom_char(ccode3, row_vals3);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_unlock_custom_char_row_vals3_65538_215
	movx	@dptr,a
	mov	a,#(_handle_unlock_custom_char_row_vals3_65538_215 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x33
	lcall	_create_custom_char
;	lcd.c:760: lcdgotoxy('2', '6');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x36
	movx	@dptr,a
	mov	dpl,#0x32
	lcall	_lcdgotoxy
;	lcd.c:761: lcdputch(ccode3 - '0');
	mov	dpl,#0x03
	lcall	_lcdputch
;	lcd.c:763: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
	mov	c,_handle_unlock_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:769: unsigned char row_vals4[8] = {0x03, 0x04, 0x08, 0x10, 0x10, 0x10, 0x10, 0x10};
	mov	dptr,#_handle_unlock_custom_char_row_vals4_65539_217
	mov	a,#0x03
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals4_65539_217 + 0x0001)
	inc	a
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals4_65539_217 + 0x0002)
	rl	a
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals4_65539_217 + 0x0003)
	rl	a
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals4_65539_217 + 0x0004)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals4_65539_217 + 0x0005)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals4_65539_217 + 0x0006)
	movx	@dptr,a
	mov	dptr,#(_handle_unlock_custom_char_row_vals4_65539_217 + 0x0007)
	movx	@dptr,a
;	lcd.c:779: }
	setb	_handle_unlock_custom_char_sloc0_1_0
	jbc	ea,00106$
	clr	_handle_unlock_custom_char_sloc0_1_0
00106$:
;	lcd.c:773: create_custom_char(ccode4, row_vals4);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_unlock_custom_char_row_vals4_65539_217
	movx	@dptr,a
	mov	a,#(_handle_unlock_custom_char_row_vals4_65539_217 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x34
	lcall	_create_custom_char
;	lcd.c:775: lcdgotoxy('2', '5');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x35
	movx	@dptr,a
	mov	dpl,#0x32
	lcall	_lcdgotoxy
;	lcd.c:776: lcdputch(ccode4 - '0');
	mov	dpl,#0x04
	lcall	_lcdputch
;	lcd.c:778: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
...
;	lcd.c:781: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'handle_newuser_custom_char'
;------------------------------------------------------------
;ccode1                    Allocated with name '_handle_newuser_custom_char_ccode1_65536_220'
;row_vals1                 Allocated with name '_handle_newuser_custom_char_row_vals1_65536_220'
;ccode2                    Allocated with name '_handle_newuser_custom_char_ccode2_65537_222'
;row_vals2                 Allocated with name '_handle_newuser_custom_char_row_vals2_65537_222'
;ccode3                    Allocated with name '_handle_newuser_custom_char_ccode3_65538_224'
;row_vals3                 Allocated with name '_handle_newuser_custom_char_row_vals3_65538_224'
;ccode4                    Allocated with name '_handle_newuser_custom_char_ccode4_65539_226'
;row_vals4                 Allocated with name '_handle_newuser_custom_char_row_vals4_65539_226'
;------------------------------------------------------------
;	lcd.c:782: void handle_newuser_custom_char(void)
;	-----------------------------------------
;	 function handle_newuser_custom_char
;	-----------------------------------------
_handle_newuser_custom_char:
;	lcd.c:786: unsigned char row_vals1[8] = {0x00, 0x00, 0x07, 0x08, 0x10, 0x10, 0x10, 0x10};
	mov	dptr,#_handle_newuser_custom_char_row_vals1_65536_220
	clr	a
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals1_65536_220 + 0x0001)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals1_65536_220 + 0x0002)
	mov	a,#0x07
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals1_65536_220 + 0x0003)
	inc	a
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals1_65536_220 + 0x0004)
	rl	a
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals1_65536_220 + 0x0005)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals1_65536_220 + 0x0006)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals1_65536_220 + 0x0007)
	movx	@dptr,a
;	lcd.c:793: }
	setb	_handle_newuser_custom_char_sloc0_1_0
	jbc	ea,00103$
	clr	_handle_newuser_custom_char_sloc0_1_0
00103$:
;	lcd.c:789: create_custom_char(ccode1, row_vals1);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_newuser_custom_char_row_vals1_65536_220
	movx	@dptr,a
	mov	a,#(_handle_newuser_custom_char_row_vals1_65536_220 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x31
	lcall	_create_custom_char
;	lcd.c:791: lcdgotoxy('3', '7');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x37
	movx	@dptr,a
	mov	dpl,#0x33
	lcall	_lcdgotoxy
;	lcd.c:792: lcdputch(ccode1 - '0');
	mov	dpl,#0x01
	lcall	_lcdputch
	mov	c,_handle_newuser_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:797: unsigned char row_vals2[8] = {0x00, 0x00, 0x1C, 0x02, 0x09, 0x1D, 0x09, 0x01};
	mov	dptr,#_handle_newuser_custom_char_row_vals2_65537_222
	clr	a
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals2_65537_222 + 0x0001)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals2_65537_222 + 0x0002)
	mov	a,#0x1c
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals2_65537_222 + 0x0003)
	mov	a,#0x02
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals2_65537_222 + 0x0004)
	mov	a,#0x09
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals2_65537_222 + 0x0005)
	mov	a,#0x1d
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals2_65537_222 + 0x0006)
	mov	a,#0x09
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals2_65537_222 + 0x0007)
	mov	a,#0x01
	movx	@dptr,a
;	lcd.c:806: }
	setb	_handle_newuser_custom_char_sloc0_1_0
	...
	clr	_handle_newuser_custom_char_sloc0_1_0
00104$:
;	lcd.c:800: create_custom_char(ccode2, row_vals2);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_newuser_custom_char_row_vals2_65537_222
	movx	@dptr,a
	mov	a,#(_handle_newuser_custom_char_row_vals2_65537_222 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x32
	lcall	_create_custom_char
;	lcd.c:802: lcdgotoxy('3', '8');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x38
	movx	@dptr,a
	mov	dpl,#0x33
	lcall	_lcdgotoxy
;	lcd.c:803: lcdputch(ccode2 - '0');
	mov	dpl,#0x02
	lcall	_lcdputch
;	lcd.c:805: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
	mov	c,_handle_newuser_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:810: unsigned char row_vals3[8] = {0x00, 0x00, 0x00, 0x00, 0x03, 0x04, 0x04, 0x03};
	mov	dptr,#_handle_newuser_custom_char_row_vals3_65538_224
	clr	a
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals3_65538_224 + 0x0001)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals3_65538_224 + 0x0002)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals3_65538_224 + 0x0003)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals3_65538_224 + 0x0004)
	mov	a,#0x03
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals3_65538_224 + 0x0005)
	inc	a
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals3_65538_224 + 0x0006)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals3_65538_224 + 0x0007)
	dec	a
	movx	@dptr,a
;	lcd.c:819: }
	setb	_handle_newuser_custom_char_sloc0_1_0
	...
	clr	_handle_newuser_custom_char_sloc0_1_0
00105$:
;	lcd.c:813: create_custom_char(ccode3, row_vals3);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_newuser_custom_char_row_vals3_65538_224
	movx	@dptr,a
	mov	a,#(_handle_newuser_custom_char_row_vals3_65538_224 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x33
	lcall	_create_custom_char
;	lcd.c:815: lcdgotoxy('2', '7');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x37
	movx	@dptr,a
	mov	dpl,#0x32
	lcall	_lcdgotoxy
;	lcd.c:816: lcdputch(ccode3 - '0');
	mov	dpl,#0x03
	lcall	_lcdputch
;	lcd.c:818: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
	mov	c,_handle_newuser_custom_char_sloc0_1_0
	mov	ea,c
;	lcd.c:823: unsigned char row_vals4[8] = {0x00, 0x00, 0x00, 0x00, 0x18, 0x04, 0x04, 0x18};
	mov	dptr,#_handle_newuser_custom_char_row_vals4_65539_226
	clr	a
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals4_65539_226 + 0x0001)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals4_65539_226 + 0x0002)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals4_65539_226 + 0x0003)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals4_65539_226 + 0x0004)
	mov	a,#0x18
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals4_65539_226 + 0x0005)
	mov	a,#0x04
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals4_65539_226 + 0x0006)
	movx	@dptr,a
	mov	dptr,#(_handle_newuser_custom_char_row_vals4_65539_226 + 0x0007)
	mov	a,#0x18
	movx	@dptr,a
;	lcd.c:832: }
	setb	_handle_newuser_custom_char_sloc0_1_0
	...
	clr	_handle_newuser_custom_char_sloc0_1_0
00106$:
;	lcd.c:826: create_custom_char(ccode4, row_vals4);
	mov	dptr,#_create_custom_char_PARM_2
	mov	a,#_handle_newuser_custom_char_row_vals4_65539_226
	movx	@dptr,a
	mov	a,#(_handle_newuser_custom_char_row_vals4_65539_226 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	dpl,#0x34
	lcall	_create_custom_char
;	lcd.c:828: lcdgotoxy('2', '8');
	mov	dptr,#_lcdgotoxy_PARM_2
	mov	a,#0x38
	movx	@dptr,a
	mov	dpl,#0x32
	lcall	_lcdgotoxy
;	lcd.c:829: lcdputch(ccode4 - '0');
	mov	dpl,#0x04
	lcall	_lcdputch
;	lcd.c:831: lcdgotoaddr(save_cursor_address);
	mov	dptr,#_save_cursor_address
	movx	a,@dptr
	mov	dpl,a
	lcall	_lcdgotoaddr
...
;------------------------------------------------------------
;str                       Allocated with name '_print_author_str_65537_230'
;------------------------------------------------------------
;	lcd.c:836: void print_author(void)
;	-----------------------------------------
;	 function print_author
;	-----------------------------------------
_print_author:
;	lcd.c:839: printf_tiny("\033[1;33m\n\rAuthor Info Printed !!\r\n");
	mov	a,#___str_33
	push	acc
	mov	a,#(___str_33 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	lcd.c:843: str = "Kiran Jojare    ESD Summer 2023 Lab 4           ";
;	lcd.c:854: }
	setb	_print_author_sloc0_1_0
	jbc	ea,00103$
	clr	_print_author_sloc0_1_0
00103$:
;	lcd.c:849: lcdgotoaddr(0x00);
	mov	dpl,#0x00
	lcall	_lcdgotoaddr
;	lcd.c:850: lcdputstr(str);
	mov	dptr,#___str_34
	mov	b,#0x80
	lcall	_lcdputstr
;	lcd.c:853: lcdgotoaddr(0x00);
	mov	dpl,#0x00
	lcall	_lcdgotoaddr
