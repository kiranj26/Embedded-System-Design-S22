...
;------------------------------------------------------------
;	string_func.c:53: int putchar (int c)
;	-----------------------------------------
;	 function putchar
;	-----------------------------------------
_putchar:
	...
	inc	dptr
	movx	@dptr,a
;	string_func.c:55: while(!TI); //Wait till the Transmitter is ready
00101$:
	jnb	_TI,00101$
;	string_func.c:56: SBUF = c; //write character to SBUF
	mov	dptr,#_putchar_c_65536_49
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	mov	r7,a
	mov	_SBUF,r6
;	string_func.c:57: TI = 0; //Clear the TI flag
;	assignBit
	clr	_TI
;	string_func.c:58: return c;
	mov	dpl,r6
	mov	dph,r7
;	string_func.c:59: }
	ret
...
;------------------------------------------------------------
;	string_func.c:70: void gets_(__xdata char *ch) {
;	-----------------------------------------
;	 function gets_
;	-----------------------------------------
_gets_:
	...
	inc	dptr
	movx	@dptr,a
;	string_func.c:71: for (int i = 0; ; i++) {
	mov	dptr,#_gets__ch_65536_51
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	mov	r5,#0x00
00105$:
;	string_func.c:72: char c = getchar();
	push	ar7
	push	ar6
	push	ar5
	push	ar4
...
;	string_func.c:73: putchar(c);
	...
	pop	ar6
	pop	ar7
;	string_func.c:74: if (c == '\r' || c == '\n') {
	cjne	r2,#0x0d,00118$
	sjmp	00101$
00118$:
	cjne	r2,#0x0a,00102$
00101$:
;	string_func.c:75: *(ch + i) = '\0';
	mov	dptr,#_gets__ch_65536_51
	movx	a,@dptr
	mov	r1,a
	inc	dptr
	...
	clr	a
	movx	@dptr,a
;	string_func.c:76: break;
	ret
00102$:
;	string_func.c:78: *(ch + i) = c;
	mov	a,r4
	add	a,r6
	mov	dpl,a
	mov	a,r5
...
;------------------------------------------------------------
;	string_func.c:90: void puts_(__xdata char *ch) {
;	-----------------------------------------
;	 function puts_
;	-----------------------------------------
_puts_:
	...
	mov	r7,a
00103$:
;	string_func.c:91: for (; *ch; ch++) {
	mov	dpl,r6
	mov	dph,r7
	movx	a,@dptr
	mov	r5,a
	jz	00109$
;	string_func.c:92: putchar(*ch);
	mov	r4,#0x00
	mov	dpl,r5
	mov	dph,r4
	push	ar7
...
;------------------------------------------------------------
;	string_func.c:96: void my_printf(__xdata uint8_t* text_ptr)
;	-----------------------------------------
;	 function my_printf
;	-----------------------------------------
_my_printf:
	...
	inc	dptr
	movx	@dptr,a
;	string_func.c:98: while(*text_ptr!='\0')
	mov	dptr,#_my_printf_text_ptr_65536_60
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00101$:
	...
	mov	r5,a
	jz	00108$
;	string_func.c:100: putchar(*text_ptr);
	mov	r4,#0x00
	mov	dpl,r5
	mov	dph,r4
	push	ar7
