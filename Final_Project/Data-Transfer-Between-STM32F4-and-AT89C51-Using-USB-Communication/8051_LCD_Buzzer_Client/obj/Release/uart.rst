      ...
      000000                        453 	.ds 8
                                    ...
                                    480 ;--------------------------------------------------------
                                    481 	.area XSEG    (XDATA)
      0004FB                        482 _putchar_c_65536_97:
      0004FB                        483 	.ds 2
      0004FD                        484 _getchar_save_cursor_address_131072_101:
      0004FD                        485 	.ds 1
      0004FE                        486 _print_colored_PARM_2:
      0004FE                        487 	.ds 2
      000500                        488 _print_colored_str_65536_102:
      000500                        489 	.ds 3
                                    490 ;--------------------------------------------------------
      ...
      00152A 22               [24]  563 	ret
                                    ...
                                    572 ;	-----------------------------------------
      00152B                        573 _putchar:
      00152B AF 83            [24]  574 	mov	r7,dph
      00152D E5 82            [12]  575 	mov	a,dpl
      00152F 90 04 FB         [24]  576 	mov	dptr,#_putchar_c_65536_97
      001532 F0               [24]  577 	movx	@dptr,a
      001533 EF               [12]  578 	mov	a,r7
      001534 A3               [24]  579 	inc	dptr
      001535 F0               [24]  580 	movx	@dptr,a
                                    581 ;	uart.c:64: while (!TI);    // Wait for the transmit interrupt flag to be set
      001536                        582 00101$:
      001536 30 99 FD         [24]  583 	jnb	_TI,00101$
                                    584 ;	uart.c:65: SBUF = c;       // Load the transmit buffer with the character to send
      001539 90 04 FB         [24]  585 	mov	dptr,#_putchar_c_65536_97
      00153C E0               [24]  586 	movx	a,@dptr
      00153D FE               [12]  587 	mov	r6,a
      00153E A3               [24]  588 	inc	dptr
      00153F E0               [24]  589 	movx	a,@dptr
      001540 FF               [12]  590 	mov	r7,a
      001541 8E 99            [24]  591 	mov	_SBUF,r6
                                    592 ;	uart.c:66: TI = 0;         // Clear transmit interrupt flag
                                    593 ;	assignBit
      001543 C2 99            [12]  594 	clr	_TI
                                    595 ;	uart.c:67: return c;
      001545 8E 82            [24]  596 	mov	dpl,r6
      001547 8F 83            [24]  597 	mov	dph,r7
                                    598 ;	uart.c:68: }
      001549 22               [24]  599 	ret
                                    600 ;------------------------------------------------------------
      ...
      00154A                        611 00101$:
      00154A 20 98 5A         [24]  612 	jb	_RI,00103$
                                    613 ;	uart.c:75: volatile uint8_t save_cursor_address = get_cursor_address();   // Save the current cursor address
      00154D 12 01 7B         [24]  614 	lcall	_get_cursor_address
      001550 E5 82            [12]  615 	mov	a,dpl
      001552 90 04 FD         [24]  616 	mov	dptr,#_getchar_save_cursor_address_131072_101
      001555 F0               [24]  617 	movx	@dptr,a
                                    618 ;	uart.c:76: lcdgotoaddr(0x59);      // Set the cursor to the start of the line that displays the time
      001556 75 82 59         [24]  619 	mov	dpl,#0x59
      001559 12 01 88         [24]  620 	lcall	_lcdgotoaddr
                                    621 ;	uart.c:77: lcdputch(minutes_tens_digit);   // Display the tens digit of the minutes
      00155C 90 05 7B         [24]  622 	mov	dptr,#_minutes_tens_digit
      00155F E0               [24]  623 	movx	a,@dptr
      001560 F5 82            [12]  624 	mov	dpl,a
      001562 12 02 5E         [24]  625 	lcall	_lcdputch
                                    626 ;	uart.c:78: lcdputch(minutes_ones_digit);   // Display the ones digit of the minutes
      001565 90 05 7A         [24]  627 	mov	dptr,#_minutes_ones_digit
      001568 E0               [24]  628 	movx	a,@dptr
      001569 F5 82            [12]  629 	mov	dpl,a
      00156B 12 02 5E         [24]  630 	lcall	_lcdputch
                                    631 ;	uart.c:79: lcdputch(':');          // Display the colon separator
      00156E 75 82 3A         [24]  632 	mov	dpl,#0x3a
      001571 12 02 5E         [24]  633 	lcall	_lcdputch
                                    634 ;	uart.c:80: lcdputch(seconds_tens_digit);   // Display the tens digit of the seconds
      001574 90 05 79         [24]  635 	mov	dptr,#_seconds_tens_digit
      001577 E0               [24]  636 	movx	a,@dptr
      001578 F5 82            [12]  637 	mov	dpl,a
      00157A 12 02 5E         [24]  638 	lcall	_lcdputch
                                    639 ;	uart.c:81: lcdputch(seconds_ones_digit);   // Display the ones digit of the seconds
      00157D 90 05 78         [24]  640 	mov	dptr,#_seconds_ones_digit
      001580 E0               [24]  641 	movx	a,@dptr
      001581 F5 82            [12]  642 	mov	dpl,a
      001583 12 02 5E         [24]  643 	lcall	_lcdputch
                                    644 ;	uart.c:82: lcdputch('.');          // Display the decimal point separator
      001586 75 82 2E         [24]  645 	mov	dpl,#0x2e
      001589 12 02 5E         [24]  646 	lcall	_lcdputch
                                    647 ;	uart.c:83: lcdputch(tenth_of_second);      // Display the tenths of seconds
      00158C 90 05 77         [24]  648 	mov	dptr,#_tenth_of_second
      00158F E0               [24]  649 	movx	a,@dptr
      001590 F5 82            [12]  650 	mov	dpl,a
      001592 12 02 5E         [24]  651 	lcall	_lcdputch
                                    652 ;	uart.c:84: lcdgotoaddr(save_cursor_address);   // Restore the cursor to the previous location
      001595 90 04 FD         [24]  653 	mov	dptr,#_getchar_save_cursor_address_131072_101
      001598 E0               [24]  654 	movx	a,@dptr
      001599 F5 82            [12]  655 	mov	dpl,a
      00159B 12 01 88         [24]  656 	lcall	_lcdgotoaddr
                                    657 ;	uart.c:85: update_lcd = 0;         // Reset the flag that indicates a change in the time display
      00159E 90 05 75         [24]  658 	mov	dptr,#_update_lcd
      0015A1 E4               [12]  659 	clr	a
      0015A2 F0               [24]  660 	movx	@dptr,a
      0015A3 A3               [24]  661 	inc	dptr
      0015A4 F0               [24]  662 	movx	@dptr,a
      0015A5 80 A3            [24]  663 	sjmp	00101$
      0015A7                        664 00103$:
                                    665 ;	uart.c:87: RI = 0;             // Clear receive interrupt flag
                                    666 ;	assignBit
      0015A7 C2 98            [12]  667 	clr	_RI
                                    668 ;	uart.c:88: return SBUF;        // Return the received character from the receive buffer
      0015A9 AE 99            [24]  669 	mov	r6,_SBUF
      0015AB 7F 00            [12]  670 	mov	r7,#0x00
      0015AD 8E 82            [24]  671 	mov	dpl,r6
      0015AF 8F 83            [24]  672 	mov	dph,r7
                                    673 ;	uart.c:89: }
      0015B1 22               [24]  674 	ret
                                    675 ;------------------------------------------------------------
                                    ...
                                    684 ;	-----------------------------------------
      0015B2                        685 _print_colored:
      0015B2 AF F0            [24]  686 	mov	r7,b
      0015B4 AE 83            [24]  687 	mov	r6,dph
      0015B6 E5 82            [12]  688 	mov	a,dpl
      0015B8 90 05 00         [24]  689 	mov	dptr,#_print_colored_str_65536_102
      0015BB F0               [24]  690 	movx	@dptr,a
      0015BC EE               [12]  691 	mov	a,r6
      0015BD A3               [24]  692 	inc	dptr
      0015BE F0               [24]  693 	movx	@dptr,a
      0015BF EF               [12]  694 	mov	a,r7
      0015C0 A3               [24]  695 	inc	dptr
      0015C1 F0               [24]  696 	movx	@dptr,a
                                    697 ;	uart.c:93: printf("\033[1;%dm%s\033[0m", color_code, str);
      0015C2 90 05 00         [24]  698 	mov	dptr,#_print_colored_str_65536_102
      0015C5 E0               [24]  699 	movx	a,@dptr
      0015C6 C0 E0            [24]  700 	push	acc
      0015C8 A3               [24]  701 	inc	dptr
      0015C9 E0               [24]  702 	movx	a,@dptr
      0015CA C0 E0            [24]  703 	push	acc
      0015CC A3               [24]  704 	inc	dptr
      0015CD E0               [24]  705 	movx	a,@dptr
      0015CE C0 E0            [24]  706 	push	acc
      0015D0 90 04 FE         [24]  707 	mov	dptr,#_print_colored_PARM_2
      0015D3 E0               [24]  708 	movx	a,@dptr
      0015D4 C0 E0            [24]  709 	push	acc
      0015D6 A3               [24]  710 	inc	dptr
      0015D7 E0               [24]  711 	movx	a,@dptr
      0015D8 C0 E0            [24]  712 	push	acc
      0015DA 74 68            [12]  713 	mov	a,#___str_0
      0015DC C0 E0            [24]  714 	push	acc
      0015DE 74 2E            [12]  715 	mov	a,#(___str_0 >> 8)
      0015E0 C0 E0            [24]  716 	push	acc
      0015E2 74 80            [12]  717 	mov	a,#0x80
      0015E4 C0 E0            [24]  718 	push	acc
      0015E6 12 1F 35         [24]  719 	lcall	_printf
      0015E9 E5 81            [12]  720 	mov	a,sp
      0015EB 24 F8            [12]  721 	add	a,#0xf8
      0015ED F5 81            [12]  722 	mov	sp,a
                                    723 ;	uart.c:94: }
      0015EF 22               [24]  724 	ret
                                    725 ;------------------------------------------------------------
                                    ...
                                    731 ;	-----------------------------------------
      0015F0                        732 _print_UI:
                                    733 ;	uart.c:99: print_colored("+-------------------------------------------------+\n\r", 35);
      0015F0 90 04 FE         [24]  734 	mov	dptr,#_print_colored_PARM_2
      0015F3 74 23            [12]  735 	mov	a,#0x23
      0015F5 F0               [24]  736 	movx	@dptr,a
      0015F6 E4               [12]  737 	clr	a
      0015F7 A3               [24]  738 	inc	dptr
      0015F8 F0               [24]  739 	movx	@dptr,a
      0015F9 90 2E 76         [24]  740 	mov	dptr,#___str_1
      0015FC 75 F0 80         [24]  741 	mov	b,#0x80
      0015FF 12 15 B2         [24]  742 	lcall	_print_colored
                                    743 ;	uart.c:100: print_colored("|           Hello STM32F411E-Discovery            |\n\r", 35);
      001602 90 04 FE         [24]  744 	mov	dptr,#_print_colored_PARM_2
      001605 74 23            [12]  745 	mov	a,#0x23
      001607 F0               [24]  746 	movx	@dptr,a
      001608 E4               [12]  747 	clr	a
      001609 A3               [24]  748 	inc	dptr
      00160A F0               [24]  749 	movx	@dptr,a
      00160B 90 2E AC         [24]  750 	mov	dptr,#___str_2
      00160E 75 F0 80         [24]  751 	mov	b,#0x80
      001611 12 15 B2         [24]  752 	lcall	_print_colored
                                    753 ;	uart.c:101: print_colored("|                                                 |\n\r", 35);
      001614 90 04 FE         [24]  754 	mov	dptr,#_print_colored_PARM_2
      001617 74 23            [12]  755 	mov	a,#0x23
      001619 F0               [24]  756 	movx	@dptr,a
      00161A E4               [12]  757 	clr	a
      00161B A3               [24]  758 	inc	dptr
      00161C F0               [24]  759 	movx	@dptr,a
      00161D 90 2E E2         [24]  760 	mov	dptr,#___str_3
      001620 75 F0 80         [24]  761 	mov	b,#0x80
      001623 12 15 B2         [24]  762 	lcall	_print_colored
                                    763 ;	uart.c:102: print_colored("+-------------------------------------------------+\n\r\n\r", 35);
      001626 90 04 FE         [24]  764 	mov	dptr,#_print_colored_PARM_2
      001629 74 23            [12]  765 	mov	a,#0x23
      00162B F0               [24]  766 	movx	@dptr,a
      00162C E4               [12]  767 	clr	a
      00162D A3               [24]  768 	inc	dptr
      00162E F0               [24]  769 	movx	@dptr,a
      00162F 90 2F 18         [24]  770 	mov	dptr,#___str_4
      001632 75 F0 80         [24]  771 	mov	b,#0x80
                                    772 ;	uart.c:191: }
      001635 02 15 B2         [24]  773 	ljmp	_print_colored
                                    774 	.area CSEG    (CODE)
                                    775 	.area CONST   (CODE)
                                    776 	.area CONST   (CODE)
      002E68                        777 ___str_0:
      002E68 1B                     778 	.db 0x1b
      002E69 5B 31 3B 25 64 6D 25   779 	.ascii "[1;%dm%s"
             73
      002E71 1B                     780 	.db 0x1b
      002E72 5B 30 6D               781 	.ascii "[0m"
      002E75 00                     782 	.db 0x00
                                    783 	.area CSEG    (CODE)
                                    784 	.area CONST   (CODE)
      002E76                        785 ___str_1:
      002E76 2B 2D 2D 2D 2D 2D 2D   786 	.ascii "+-------------------------------------------------+"
             ...
             2D 2D 2D 2D 2D 2D 2D
             2D 2B
      002EA9 0A                     787 	.db 0x0a
      002EAA 0D                     788 	.db 0x0d
      002EAB 00                     789 	.db 0x00
                                    790 	.area CSEG    (CODE)
                                    791 	.area CONST   (CODE)
      002EAC                        792 ___str_2:
      002EAC 7C 20 20 20 20 20 20   793 	.ascii "|           Hello STM32F411E-Discovery            |"
             ...
             20 7C
      002EDF 0A                     794 	.db 0x0a
      002EE0 0D                     795 	.db 0x0d
      002EE1 00                     796 	.db 0x00
                                    797 	.area CSEG    (CODE)
                                    798 	.area CONST   (CODE)
      002EE2                        799 ___str_3:
      002EE2 7C 20 20 20 20 20 20   800 	.ascii "|                                                 |"
             20 20 20 20 20 20 20
             20 20 20 20 20 20 20
             20 20 20 20 20 20 20
             20 20 20 20 20 20 20
             ...
             20 20 20 20 20 20 20
             20 7C
      002F15 0A                     801 	.db 0x0a
      002F16 0D                     802 	.db 0x0d
      002F17 00                     803 	.db 0x00
                                    804 	.area CSEG    (CODE)
                                    805 	.area CONST   (CODE)
      002F18                        806 ___str_4:
      002F18 2B 2D 2D 2D 2D 2D 2D   807 	.ascii "+-------------------------------------------------+"
             2D 2D 2D 2D 2D 2D 2D
             2D 2D 2D 2D 2D 2D 2D
             2D 2D 2D 2D 2D 2D 2D
             2D 2D 2D 2D 2D 2D 2D
             ...
             2D 2D 2D 2D 2D 2D 2D
             2D 2B
      002F4B 0A                     808 	.db 0x0a
      002F4C 0D                     809 	.db 0x0d
      002F4D 0A                     810 	.db 0x0a
      002F4E 0D                     811 	.db 0x0d
      002F4F 00                     812 	.db 0x00
                                    813 	.area CSEG    (CODE)
                                    814 	.area XINIT   (CODE)
