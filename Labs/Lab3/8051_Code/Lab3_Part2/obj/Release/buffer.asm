...
___str_5:
	...
	.ascii "[0;31m"
	.db 0x0a
	.ascii "Invalid input. Please enter four digits between 0 and 9."
	.db 0x0a
	.db 0x0d
	.db 0x00
	.area CSEG    (CODE)
...
___str_7:
	...
	.ascii "[0;31m"
	.db 0x0a
	.ascii "Invalid input.Input data should be between 64 and 5600."
	.db 0x0a
	.db 0x00
	.area CSEG    (CODE)
	.area CONST   (CODE)
___str_8:
	...
	.ascii "[0;31m"
	.db 0x0a
	.ascii "Invalid input.Input not divisible by 32."
	.db 0x0a
	.db 0x00
	.area CSEG    (CODE)
	.area XINIT   (CODE)
