                                    ...
                                    219 	.globl _RCAP2L
                                    220 	.globl _T2CON
                                    221 	.globl _fclk_periph_min_freq
                                    222 	.globl _fclk_periph_max_freq
                                    223 	.globl _ucontroller_idle_mode
                                    224 	.globl _ucontroller_power_down_mode
                                    225 ;--------------------------------------------------------
      ...
      000000                        448 	.ds 8
                                    ...
                                    510 	.area CSEG    (CODE)
                                    511 ;------------------------------------------------------------
                                    512 ;Allocation info for local variables in function 'fclk_periph_min_freq'
                                    513 ;------------------------------------------------------------
                                    514 ;	clock.c:38: void fclk_periph_min_freq(void)
                                    515 ;	-----------------------------------------
                                    516 ;	 function fclk_periph_min_freq
                                    517 ;	-----------------------------------------
      000062                        518 _fclk_periph_min_freq:
                           000007   519 	ar7 = 0x07
                           000006   520 	ar6 = 0x06
                           000005   521 	ar5 = 0x05
                           000004   522 	ar4 = 0x04
                           ...
                           000001   525 	ar1 = 0x01
                           000000   526 	ar0 = 0x00
                                    527 ;	clock.c:40: CKRL = 0x01;
      000062 75 97 01         [24]  528 	mov	_CKRL,#0x01
                                    529 ;	clock.c:41: printf("\033[1;33mFclk_periph Minimum Frequency active  !!\r\n");
      000065 74 12            [12]  530 	mov	a,#___str_0
      000067 C0 E0            [24]  531 	push	acc
      000069 74 10            [12]  532 	mov	a,#(___str_0 >> 8)
      00006B C0 E0            [24]  533 	push	acc
      00006D 74 80            [12]  534 	mov	a,#0x80
      00006F C0 E0            [24]  535 	push	acc
      000071 12 05 AA         [24]  536 	lcall	_printf
      000074 15 81            [12]  537 	dec	sp
      000076 15 81            [12]  538 	dec	sp
      000078 15 81            [12]  539 	dec	sp
                                    540 ;	clock.c:43: return;
                                    541 ;	clock.c:44: }
      00007A 22               [24]  542 	ret
                                    543 ;------------------------------------------------------------
                                    544 ;Allocation info for local variables in function 'fclk_periph_max_freq'
                                    545 ;------------------------------------------------------------
                                    546 ;	clock.c:54: void fclk_periph_max_freq(void)
                                    547 ;	-----------------------------------------
                                    548 ;	 function fclk_periph_max_freq
                                    549 ;	-----------------------------------------
      00007B                        550 _fclk_periph_max_freq:
                                    551 ;	clock.c:56: CKRL = 0xFF;
      00007B 75 97 FF         [24]  552 	mov	_CKRL,#0xff
                                    553 ;	clock.c:57: printf("\033[1;33mFclk_periph Maximum Frequency active  !!\r\n");
      00007E 74 44            [12]  554 	mov	a,#___str_1
      000080 C0 E0            [24]  555 	push	acc
      000082 74 10            [12]  556 	mov	a,#(___str_1 >> 8)
      000084 C0 E0            [24]  557 	push	acc
      000086 74 80            [12]  558 	mov	a,#0x80
      000088 C0 E0            [24]  559 	push	acc
      00008A 12 05 AA         [24]  560 	lcall	_printf
      00008D 15 81            [12]  561 	dec	sp
      00008F 15 81            [12]  562 	dec	sp
      000091 15 81            [12]  563 	dec	sp
                                    564 ;	clock.c:59: return;
                                    565 ;	clock.c:60: }
      000093 22               [24]  566 	ret
                                    567 ;------------------------------------------------------------
                                    568 ;Allocation info for local variables in function 'ucontroller_idle_mode'
                                    569 ;------------------------------------------------------------
                                    570 ;	clock.c:71: void ucontroller_idle_mode(void)
                                    571 ;	-----------------------------------------
                                    572 ;	 function ucontroller_idle_mode
                                    573 ;	-----------------------------------------
      000094                        574 _ucontroller_idle_mode:
                                    575 ;	clock.c:73: printf("\033[1;33mMicrocontroller Entering IDLE mode  !!\r\n");
      000094 74 76            [12]  576 	mov	a,#___str_2
      000096 C0 E0            [24]  577 	push	acc
      000098 74 10            [12]  578 	mov	a,#(___str_2 >> 8)
      00009A C0 E0            [24]  579 	push	acc
      00009C 74 80            [12]  580 	mov	a,#0x80
      00009E C0 E0            [24]  581 	push	acc
      0000A0 12 05 AA         [24]  582 	lcall	_printf
      0000A3 15 81            [12]  583 	dec	sp
      0000A5 15 81            [12]  584 	dec	sp
      0000A7 15 81            [12]  585 	dec	sp
                                    586 ;	clock.c:75: IT0 = 1; // Set the interrupt type for INT0 (0 = level-triggered, 1 = edge-triggered)
                                    587 ;	assignBit
      0000A9 D2 88            [12]  588 	setb	_IT0
                                    589 ;	clock.c:76: EX0 = 1; // Enable external interrupt 0
                                    590 ;	assignBit
      0000AB D2 A8            [12]  591 	setb	_EX0
                                    592 ;	clock.c:77: EA = 1;  // Enable global interrupts
                                    593 ;	assignBit
      0000AD D2 AF            [12]  594 	setb	_EA
                                    595 ;	clock.c:78: ES = 0;
                                    596 ;	assignBit
      0000AF C2 AC            [12]  597 	clr	_ES
                                    598 ;	clock.c:80: PCON |= 0x01;
      0000B1 43 87 01         [24]  599 	orl	_PCON,#0x01
                                    600 ;	clock.c:82: return;
                                    601 ;	clock.c:83: }
      0000B4 22               [24]  602 	ret
                                    603 ;------------------------------------------------------------
                                    604 ;Allocation info for local variables in function 'ucontroller_power_down_mode'
                                    605 ;------------------------------------------------------------
                                    606 ;	clock.c:93: void ucontroller_power_down_mode(void)
                                    607 ;	-----------------------------------------
                                    608 ;	 function ucontroller_power_down_mode
                                    609 ;	-----------------------------------------
      0000B5                        610 _ucontroller_power_down_mode:
                                    611 ;	clock.c:95: PCON |= 0x02;
      0000B5 43 87 02         [24]  612 	orl	_PCON,#0x02
                                    613 ;	clock.c:96: printf("\033[1;33mMicrocontroller Entering POWERDOWN mode  !!\r\n");
      0000B8 74 A6            [12]  614 	mov	a,#___str_3
      0000BA C0 E0            [24]  615 	push	acc
      0000BC 74 10            [12]  616 	mov	a,#(___str_3 >> 8)
      0000BE C0 E0            [24]  617 	push	acc
      0000C0 74 80            [12]  618 	mov	a,#0x80
      0000C2 C0 E0            [24]  619 	push	acc
      0000C4 12 05 AA         [24]  620 	lcall	_printf
      0000C7 15 81            [12]  621 	dec	sp
      0000C9 15 81            [12]  622 	dec	sp
      0000CB 15 81            [12]  623 	dec	sp
                                    624 ;	clock.c:98: return;
                                    625 ;	clock.c:99: }
      0000CD 22               [24]  626 	ret
                                    627 	.area CSEG    (CODE)
                                    628 	.area CONST   (CODE)
                                    629 	.area CONST   (CODE)
      001012                        630 ___str_0:
      001012 1B                     631 	.db 0x1b
      001013 5B 31 3B 33 33 6D 46   632 	.ascii "[1;33mFclk_periph Minimum Frequency active  !!"
             63 6C 6B 5F 70 65 72
             69 70 68 20 4D 69 6E
             69 6D 75 6D 20 46 72
             65 71 75 65 6E 63 79
             20 61 63 74 69 76 65
             20 20 21 21
      001041 0D                     633 	.db 0x0d
      001042 0A                     634 	.db 0x0a
      001043 00                     635 	.db 0x00
                                    636 	.area CSEG    (CODE)
                                    637 	.area CONST   (CODE)
      001044                        638 ___str_1:
      001044 1B                     639 	.db 0x1b
      001045 5B 31 3B 33 33 6D 46   640 	.ascii "[1;33mFclk_periph Maximum Frequency active  !!"
             63 6C 6B 5F 70 65 72
             69 70 68 20 4D 61 78
             69 6D 75 6D 20 46 72
             65 71 75 65 6E 63 79
             20 61 63 74 69 76 65
             20 20 21 21
      001073 0D                     641 	.db 0x0d
      001074 0A                     642 	.db 0x0a
      001075 00                     643 	.db 0x00
                                    644 	.area CSEG    (CODE)
                                    645 	.area CONST   (CODE)
      001076                        646 ___str_2:
      001076 1B                     647 	.db 0x1b
      001077 5B 31 3B 33 33 6D 4D   648 	.ascii "[1;33mMicrocontroller Entering IDLE mode  !!"
             69 63 72 6F 63 6F 6E
             74 72 6F 6C 6C 65 72
             20 45 6E 74 65 72 69
             6E 67 20 49 44 4C 45
             20 6D 6F 64 65 20 20
             21 21
      0010A3 0D                     649 	.db 0x0d
      0010A4 0A                     650 	.db 0x0a
      0010A5 00                     651 	.db 0x00
                                    652 	.area CSEG    (CODE)
                                    653 	.area CONST   (CODE)
      0010A6                        654 ___str_3:
      0010A6 1B                     655 	.db 0x1b
      0010A7 5B 31 3B 33 33 6D 4D   656 	.ascii "[1;33mMicrocontroller Entering POWERDOWN mode  !!"
             69 63 72 6F 63 6F 6E
             74 72 6F 6C 6C 65 72
             20 45 6E 74 65 72 69
             6E 67 20 50 4F 57 45
             52 44 4F 57 4E 20 6D
             6F 64 65 20 20 21 21
      0010D8 0D                     657 	.db 0x0d
      0010D9 0A                     658 	.db 0x0a
      0010DA 00                     659 	.db 0x00
                                    660 	.area CSEG    (CODE)
                                    661 	.area XINIT   (CODE)
