...
;------------------------------------------------------------
;char_detected             Allocated with name '_main_char_detected_65536_87'
;------------------------------------------------------------
...
;	main.c:91: printf_tiny("|***********************************************|\n\r\n\r");
	...
	dec	sp
	dec	sp
;	main.c:93: while(1) // it should come back to enter character
00113$:
;	main.c:96: printf_tiny("\033[1;36m|***********************************************|\n\r");
	mov	a,#___str_12
	push	acc
	mov	a,#(___str_12 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	main.c:97: printf_tiny("\033[1;36m|                Enter Character                |\n\r");
	mov	a,#___str_13
	push	acc
	mov	a,#(___str_13 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	main.c:98: printf_tiny("\033[1;36m|***********************************************|\n\r\033[1;0m");
	mov	a,#___str_14
	push	acc
	mov	a,#(___str_14 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	main.c:101: char_detected = getchar();              // Read a character from input
	lcall	_getchar
	mov	r6,dpl
;	main.c:102: putchar(char_detected);                 // Echo the character back to output
	mov	ar5,r6
	mov	r7,#0x00
	mov	dpl,r5
	mov	dph,r7
	push	ar6
	lcall	_putchar
;	main.c:103: putchar(' ');                           // Add a space to separate characters for readability
	mov	dptr,#0x0020
	lcall	_putchar
	pop	ar6
;	main.c:105: switch(char_detected)
	cjne	r6,#0x48,00157$
	sjmp	00103$
00157$:
	cjne	r6,#0x49,00158$
...
;	main.c:107: case 'R':
	...
	sjmp	00109$
00101$:
;	main.c:108: start_pwm(); // this we did first
	lcall	_start_pwm
;	main.c:109: break;
;	main.c:111: case 'S':
	sjmp	00113$
...
;	main.c:115: case 'H':
	sjmp	00113$
00103$:
;	main.c:116: start_high_speed_output();
	lcall	_start_high_speed_output
;	main.c:117: break;
	ljmp	00113$
;	main.c:119: case 'J':
00104$:
;	main.c:120: stop_high_speed_output();
	lcall	_stop_high_speed_output
;	main.c:121: break;
	ljmp	00113$
;	main.c:123: case 'M':
00105$:
;	main.c:124: fclk_periph_min_freq();
	lcall	_fclk_periph_min_freq
;	main.c:125: break;
	ljmp	00113$
;	main.c:127: case 'N':
00106$:
;	main.c:128: fclk_periph_max_freq();
	lcall	_fclk_periph_max_freq
;	main.c:129: break;
	ljmp	00113$
;	main.c:131: case 'I':
00107$:
;	main.c:132: ucontroller_idle_mode();
	lcall	_ucontroller_idle_mode
;	main.c:133: powerdown_idle_wakeup();
	lcall	_powerdown_idle_wakeup
;	main.c:134: break;
	ljmp	00113$
;	main.c:136: case 'P':
00108$:
;	main.c:137: ucontroller_power_down_mode();
	lcall	_ucontroller_power_down_mode
;	main.c:138: powerdown_idle_wakeup();
	lcall	_powerdown_idle_wakeup
;	main.c:139: break;
	ljmp	00113$
;	main.c:141: case 'W':
00109$:
;	main.c:142: printf_tiny("\033[1;31mWATCHDOG Activated!!\n\r");
	mov	a,#___str_15
	push	acc
	mov	a,#(___str_15 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	main.c:143: watchdog_init();
	lcall	_watchdog_init
;	main.c:144: break;
	ljmp	00113$
;	main.c:146: default:
00110$:
;	main.c:147: printf_tiny("\033[1;31mInvalid Character!!\n\r");
	mov	a,#___str_16
	push	acc
	mov	a,#(___str_16 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	main.c:148: printf_tiny("\033[1;31mSuggested Action\t: Available Characters R-S-H-M-N-I_P!!\n\r");
	mov	a,#___str_17
	push	acc
	mov	a,#(___str_17 >> 8)
	push	acc
