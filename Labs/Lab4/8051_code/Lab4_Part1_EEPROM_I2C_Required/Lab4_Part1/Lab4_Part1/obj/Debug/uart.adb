M:uart
F:G$initialize_uart_timer$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$int_to_char$0_0$0({2}DF,SC:U),C,0,0,0,0,0
F:G$char_to_int$0_0$0({2}DF,SC:U),C,0,0,0,0,0
F:G$parse_user_input$0_0$0({2}DF,SI:U),C,0,0,0,0,0
F:G$print_hex_number$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$print_colored$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$print_UI$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Luart.print_hex_number$sloc3$0_1$0({2}DX,SC:U),E,0,0
S:Luart.print_hex_number$sloc4$0_1$0({4}SL:U),E,0,0
S:Luart.print_hex_number$sloc0$0_1$0({1}SB0$0:S),H,0,0
S:Luart.print_hex_number$sloc1$0_1$0({1}SB0$0:S),H,0,0
S:Luart.print_hex_number$sloc2$0_1$0({1}SB0$0:S),H,0,0
S:Luart.int_to_char$num$1_0$68({2}SI:S),F,0,0
S:Luart.int_to_char$hex_digits$1_0$69({17}DA17d,SC:U),F,0,0
S:Luart.char_to_int$ch$1_0$71({1}SC:U),F,0,0
S:Luart.char_to_int$hex_digits$1_0$72({3}DG,SC:U),F,0,0
S:Luart.char_to_int$pos$1_0$72({3}DG,SC:U),F,0,0
S:Luart.parse_user_input$base$1_0$74({1}SC:U),F,0,0
S:Luart.parse_user_input$number$1_0$75({2}SI:U),F,0,0
S:Luart.parse_user_input$digits$1_0$75({40}DA20d,SI:U),F,0,0
S:Luart.parse_user_input$digit_count$1_0$75({2}SI:U),F,0,0
S:Luart.parse_user_input$i$1_0$75({2}SI:U),F,0,0
S:Luart.parse_user_input$current_char$1_0$75({2}SI:U),F,0,0
S:Luart.print_hex_number$width$1_0$82({1}SC:U),F,0,0
S:Luart.print_hex_number$num$1_0$82({4}SL:U),F,0,0
S:Luart.print_hex_number$ascii_buffer$1_0$83({10}DA10d,SC:U),F,0,0
S:Luart.print_hex_number$temp_val$1_0$83({1}SC:U),F,0,0
S:Luart.print_hex_number$digit_count$1_0$83({1}SC:S),F,0,0
S:Luart.print_hex_number$val_check$1_0$83({4}SL:U),F,0,0
S:Luart.print_colored$color_code$1_0$93({2}SI:S),F,0,0
S:Luart.print_colored$str$1_0$93({3}DG,SC:U),F,0,0
...
S:G$int_to_char$0_0$0({2}DF,SC:U),C,0,0
...
S:Fuart$__str_1$0_0$0({23}DA23d,SC:U),D,0,0
S:Fuart$__str_2$0_0$0({14}DA14d,SC:U),D,0,0
S:Fuart$__str_3$0_0$0({3}DA3d,SC:U),D,0,0
S:Fuart$__str_4$0_0$0({54}DA54d,SC:U),D,0,0
S:Fuart$__str_5$0_0$0({54}DA54d,SC:U),D,0,0
S:Fuart$__str_6$0_0$0({54}DA54d,SC:U),D,0,0
S:Fuart$__str_7$0_0$0({54}DA54d,SC:U),D,0,0
S:Fuart$__str_8$0_0$0({56}DA56d,SC:U),D,0,0
S:Fuart$__str_9$0_0$0({9}DA9d,SC:U),D,0,0
S:Fuart$__str_10$0_0$0({33}DA33d,SC:U),D,0,0
S:Fuart$__str_11$0_0$0({4}DA4d,SC:U),D,0,0
S:Fuart$__str_12$0_0$0({50}DA50d,SC:U),D,0,0
S:Fuart$__str_13$0_0$0({3}DA3d,SC:U),D,0,0
S:Fuart$__str_14$0_0$0({45}DA45d,SC:U),D,0,0
S:Fuart$__str_15$0_0$0({45}DA45d,SC:U),D,0,0
S:Fuart$__str_16$0_0$0({45}DA45d,SC:U),D,0,0
S:Fuart$__str_17$0_0$0({45}DA45d,SC:U),D,0,0
S:Fuart$__str_18$0_0$0({45}DA45d,SC:U),D,0,0
